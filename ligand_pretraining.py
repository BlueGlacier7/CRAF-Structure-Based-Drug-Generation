import torch
from scripts.model import CRAF_main
...
train_set, valid_set = LoadDataset.split(dataset, val_num=10000, shuffle=True, random_seed=42)
print("train_set=",len(train_set))
print("valid_set=",len(valid_set))

model = CRAF_main(config).to('cuda:0')
